...
- Local AmneziaWG usage is separate from imported Remnawave traffic, it is derived from node peer counters (`rx + tx`), stays reset-safe, and is not pushed back to Remnawave.
